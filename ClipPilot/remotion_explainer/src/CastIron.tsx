...
import wordsData from './castiron_words.json';

export const FPS = 30;
export const DURATION_IN_FRAMES = 1147;
...
export const Castiron: React.FC = () => {
  const third = Math.floor(DURATION_IN_FRAMES / 4);
  return (
    <AbsoluteFill style={{ backgroundColor: '#2C3E50' }}>
      <Audio src={staticFile('castiron_narration.mp3')} />
