...
import wordsData from './treesoup_words.json';

export const FPS = 30;
export const DURATION_IN_FRAMES = 1126;
...
export const Treesoup: React.FC = () => {
  const third = Math.floor(DURATION_IN_FRAMES / 4);
  return (
    <AbsoluteFill style={{ backgroundColor: '#FF9F1C' }}>
      <Audio src={staticFile('treesoup_narration.mp3')} />
