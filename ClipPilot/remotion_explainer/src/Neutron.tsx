...
import wordsData from './neutron_words.json';
      ...
      <SceneWrap>
        <svg viewBox="0 0 1080 1920" style={{ position: 'absolute', inset: 0 }}>
          <g transform={`translate(540, 960) rotate(${r})`}>
             <rect x={-400} y={-400} width={800} height={800} fill="#14213D" rx={100} />
             <circle cx={0} cy={0} r={200} fill="#FCA311" />
          </g>
        </svg>
      </SceneWrap>
    </AbsoluteFill>
...
function Scene2() {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: '#FCA311' }}>
      <SceneWrap>
        <svg viewBox="0 0 1080 1920" style={{ position: 'absolute', inset: 0 }}>
          <g transform={`translate(540, 960)`}>
             <circle cx={s} cy={-s} r={300} fill="#E5E5E5" />
             <circle cx={-s} cy={s} r={300} fill="#000000" />
          </g>
        </svg>
      </SceneWrap>
    </AbsoluteFill>
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: '#E5E5E5' }}>
      <SceneWrap>
        <svg viewBox="0 0 1080 1920" style={{ position: 'absolute', inset: 0 }}>
          <g transform={`translate(540, 960)`}>
             <polygon points="0,-400 300,200 -300,200" fill="#14213D" transform={`translate(0, ${y})`} />
             <polygon points="0,-200 150,100 -150,100" fill="#000000" transform={`translate(0, ${-y})`} />
          </g>
        </svg>
      </SceneWrap>
    </AbsoluteFill>
      ...
      <SceneWrap>
        <svg viewBox="0 0 1080 1920" style={{ position: 'absolute', inset: 0 }}>
          <g transform={`translate(540, 960) scale(${scale})`}>
             <path d="M -200,0 A 200,200 0 1,0 200,0 A 200,200 0 1,0 -200,0" fill="none" stroke="#FCA311" strokeWidth={50} strokeDasharray="100 50" />
             <path d="M -100,0 A 100,100 0 1,0 100,0 A 100,100 0 1,0 -100,0" fill="none" stroke="#E5E5E5" strokeWidth={30} />
          </g>
        </svg>
      </SceneWrap>
    </AbsoluteFill>
...
export const Neutron: React.FC = () => {
  const third = Math.floor(DURATION_IN_FRAMES / 4);
  return (
    <AbsoluteFill style={{ backgroundColor: '#000000' }}>
      <Audio src={staticFile('neutron_narration.mp3')} />
