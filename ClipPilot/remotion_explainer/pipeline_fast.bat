...
call python ..\..\.claude\skills\punchy-recut\recut.py --input out/%SLUG%.mp4 --punch 1.15 --speed 1.15 --sfx-every 1 --gameplay-dir ..\..\downloads\gta5-gameplay --gameplay-fit pad
